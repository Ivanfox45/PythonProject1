...
from parsers.w_p_r_o__parser import WPROParser
from parsers.a_f_r_o__parser import AFROParser
from parsers.e_u_r_o__parser import EUROParser
from parsers.e_m_r_o__parser import EMROParser
from parsers.m_m_w_r__parser import MMWRParser
from parsers.c_d_c__parser import CDCParser
...
from parsers.epi_south__parser import EpiSouthParser
from parsers.w_o_a_h__parser import WOAHParser
from parsers.w_a_h_i_s__parser import WAHISParser
from parsers.africa_c_d_c__parser import AfricaCDCParser
from parsers.e_d_p_l_n__parser import EDPLNParser
from parsers.pandemic_hub__parser import PandemicHubParser
from parsers.relief_web__parser import ReliefWebParser
from parsers.melioidosis__parser import MelioidosisParser
...
SITES = {
    ...
    "epi_south_": EpiSouthParser,
    "w_o_a_h_": WOAHParser,
    "w_a_h_i_s_": WAHISParser,
    "africa_c_d_c_": AfricaCDCParser,
    "e_d_p_l_n_": EDPLNParser,
    "pandemic_hub_": PandemicHubParser,
    "relief_web_": ReliefWebParser,
    "melioidosis_": MelioidosisParser,
}
